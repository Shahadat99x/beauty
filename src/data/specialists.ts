...
export const specialists: Specialist[] = [
  ...
  },
  {
    ...
    signatureServices: ["signature-brow-sculpt", "lash-lift-veil"],
    recentWorkImages: [
      { title: "Soft Brow Sculpting", aspect: "landscape", tone: "taupe" },
      { title: "Lash Lift Veil Effect", aspect: "square", tone: "blush" }
    ]
  },
  {
    slug: "sofia-larsen",
  ...
  },
  {
    ...
    signatureServices: ["radiance-facial", "cellular-renewal", "restorative-massage"],
    recentWorkImages: [
      { title: "Texture Refining Peel Result", aspect: "square", tone: "mocha" },
      { title: "Pigmentation Evening", aspect: "landscape", tone: "champagne" }
    ]
  },
];
